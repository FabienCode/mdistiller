...
def main_worker(rank, world_size, cfg, resume, opts):
    ...
    distiller = distiller.cuda(rank)
    distiller = torch.nn.parallel.DistributedDataParallel(distiller, device_ids=[rank])
