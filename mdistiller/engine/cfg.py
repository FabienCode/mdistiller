...
# DLKD config
CFG.DLKD = CN()
CFG.DLKD.TEMPERATURE = 4
CFG.DLKD.LOSS = CN()
CFG.DLKD.LOSS.CE_WEIGHT = 0.1
CFG.DLKD.LOSS.KD_WEIGHT = 0.9
CFG.DLKD.LOSS.DLKD_WEIGHT = 0.9
CFG.DLKD.LOSS.REC_LOGITS_WEIGHT = 1.0
CFG.DLKD.DIFF = CN()
CFG.DLKD.DIFF.CLS_NUM = 100
CFG.DLKD.DIFF.DIFF_NUM = 5
CFG.DLKD.DIFF.SAMPLE_STEP = 5
