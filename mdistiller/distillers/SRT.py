...
class SRT(Distiller):
    ...
    def forward_train(self, image, target, **kwargs):
        ...
        kd_student_logic = self.teacher_fc(nn.AvgPool2d(h)(feature_student["feats"][-1]).reshape(b, -1))
        loss_kd = kd_loss(kd_student_logic, logits_teacher, self.kd_temperature)
