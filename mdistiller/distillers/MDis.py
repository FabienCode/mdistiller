...
class MDis(Distiller):
    ...
    def forward_train(self, image, target, **kwargs):
        ...
        #     if i == 0:
        #         layers_bn_weight.append(self.student.layer0[0].bn2.weight)
        #     elif i == 1:
        #         layers_bn_weight.append(self.student.layer1[0].bn2.weight)
        #     elif i == 2:
        #         layers_bn_weight.append(self.student.layer2[0].bn2.weight)
        #     else:
        #         layers_bn_weight.append(self.student.layer3[0].bn2.weight)
