...
class MVKD(Distiller):
    ...
    def __init__(self, student, teacher, cfg):
        ...
        self.rec_module = Model(ch=t_c, out_ch=t_c, ch_mult=(1, 1), num_res_blocks=1, attn_resolutions=[t_w // 2, t_w],
...
def multi_loss(logits_student_weak, logits_teacher_weak,
    ...
    return loss_kd_weak + loss_kd_strong + loss_cc_weak + loss_bc_weak + loss_cc_strong + loss_bc_strong
